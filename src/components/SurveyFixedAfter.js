...
export default function SurveyFixedAfter() {
    ...
    return (
        <Box sx={{ p: 3, width: 900, alignItems: 'center', justifyContent: 'center', }}>
            ...
            <FormControlLabel control={<Checkbox checked />} label="Woodworking"/>
                <FormControlLabel control={<Checkbox checked />} label="Gardening/Growing own vegetables" />
                <FormControlLabel control={<Checkbox unchecked />} label="Upcycling used clothes" />
                <FormControlLabel control={<Checkbox unchecked />} label="Other green activities (share with us in the forum!)" />
            </FormGroup>
            </div>
